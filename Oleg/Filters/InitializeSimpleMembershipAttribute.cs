        ...
        private class SimpleMembershipInitializer
        {
            public SimpleMembershipInitializer()
            {
                ...
                try
                {
                    ...
                    if (membership.GetUser("OlegRasskazov", false) == null)
                    {
                        membership.CreateUserAndAccount("OlegRasskazov", "89Zxcv"); // создание пользователя
                        roles.AddUsersToRoles(new[] { "OlegRasskazov" }, new[] { "Admin" }); // установка роли для пользователя
                    }
